...
const SeasonTiles = ({ itemsToShow }) => {
  ...
  return itemsToShow.map(match => {
    return (
      <>
        <div className="col-md-6 col-sm-12 shadow-sm shadow  py-4 ">
          ...
          <p className="font-weight-bold text-center">
            1st Umpire : {match.umpire1}, 2nd Umpire : {match.umpire2}, 3rd
            Umpire : {match.umpire3}
          </p>
        </div>
      </>
    );
